  ...
  return (
    ...
    <Analytics/>
      <header className='animate__animated animate__slideInDown'>
        ...
        <p className='header-sub-title'>Vær oppmerksom på at resultatene generert av KI kan være unøyaktige. Denne vurderingen er kun veiledende og bør ikke betraktes som en endelig bestemmelse av språkferdigheter.</p>
      </header>
